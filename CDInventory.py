...
# NFortes, 2022-Nov-20, Added 4 function. One to put CD input data, one to append input data onto the exsisting list, one to wrie/save to file, and one to delete a CD entry.
#------------------------------------------#
...
class DataProcessor:
    ...
    @staticmethod
    def ap_list(ID, Title, Artist):
        """Function to append the list of dictionaries with user input
    
        Args:
            ID : ID of new CD
            Title : Tite of new CD
            Artist : Name of CD Artist 
        Returns:
            Appended table (list of dics)
        """
        intID = int(ID)
...
while True:
    ...
    # 3.3 process add a CD
        ...
        strID, strTitle, stArtist = IO.cd_input()

        # 3.3.2 Add item to the table
        dicRow = DataProcessor.ap_list(strID, strTitle, stArtist)
        lstTbl.append(dicRow)
            
        IO.show_inventory(lstTbl) #Leave this line
        continue  # start loop back at top.
    ...
    # 3.5 process delete a CD
        ...
        #input for line delete and error handling around it.
        try:
       ...
       # 3.5.2 search thru table and delete CD
        DataProcessor.cd_delete(lstTbl, intIDDel)    
        IO.show_inventory(lstTbl)
        continue  # start loop back at top.
